...
<body
  ...
  <section
    ...
    <div class="g-2 row d-flex flex-wrap align-items-center">
      <a href="#camisetas" class="btn btn-medium btn-black">CAMISETAS</a>
      <a href="#totebags" class="btn btn-medium btn-black">TOTEBAGS</a>
    </div>
  </section>
  <section
    id="camisetas"
          ...
          foreach ($allTotebags as $index => $totebag): ?>
            <div class="col-md-3">
              <div class="product-card position-relative">
                ...
                <div class="cart-concern position-absolute">
                  <div class="cart-button d-flex">
                    <a href="mispedidos.php?id=<?= htmlspecialchars($shirt['prod_id']); ?>" class=" btn btn-medium btn-black">
                      Añadir
                      <svg class="cart-outline">
                        <use xlink:href="../public/assets/icons/icons.svg#cart-outline"></use>
                      </svg>
