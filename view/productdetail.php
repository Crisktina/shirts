          ...
          <div class="row mt-5">
            <div class="col-lg-6">
              <div class="product-preview mb-3">
                <img src="../<?= $product['prod_photo'] ?>" alt="Foto del producto llamado <?= $product['prod_name'] ?>" class="img-fluid">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="product-info">
                <div class="element-header">
                  <h3 itemprop="name" class="display-7 text-uppercase"><?= $product['prod_name'] ?></h3>
                </div>
                <div class="product-price pt-3 pb-3">
                  <strong class="text-primary display-6 fw-bold"><?= $product['prod_price'] ?> €</strong>
                </div>
                ...
                <div class="cart-wrap padding-small">
                  ...
                  <div class="product-quantity">
                    ...
                    <?php foreach ($productDetail as $index => $shops): ?>
                      <div class="stock-number text-dark"><?= $shops['shop_name'] ?> (<?= $shops['shop_city'] ?>)</div>
                      <p><?= $shops['stock_quantity'] ?> unidades en stock</p>
                    <?php endforeach; ?>
                    <?php if (isset($_SESSION['username'])): ?>
                      <div class="stock-button-wrap pt-3">
                        ...
                        <div class="qty-button d-flex flex-wrap pt-3">
                          <button type="submit" class="btn btn-primary btn-medium text-uppercase me-3 mt-3" name="add-to-cart" value="1269">Añadir al pedido</button>
                        </div>
                      </div>
                    <?php endif; ?>
                  </div>
